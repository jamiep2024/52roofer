export const locationData = {
  ...
  reading: {
    ...
    nearbyAreas: ["Caversham", "Tilehurst", "Woodley", "Earley", "Whitley", "Calcot", "Lower Earley"],
    postalCodes: ["RG1", "RG2", "RG4", "RG6", "RG30", "RG31"],
    heritage: { conservationAreas: ["Reading Town Centre", "Market Place", "St Mary's Butts", "Russell Street"] }
  },
  newbury: {
    name: "Newbury",
    county: "Berkshire",
    ...
    heritage: { conservationAreas: ["Newbury Town Centre", "Shaw-cum-Donnington"] }
  },
  windsor: {
    name: "Windsor",
    county: "Berkshire",
    ...
    postalCodes: ["SL4"],
    heritage: { conservationAreas: ["Windsor Town Centre", "Castle Area", "Trinity Place"] }
  },
  maidenhead: {
    name: "Maidenhead",
    county: "Berkshire",
    ...
    postalCodes: ["SL6"],
    heritage: { conservationAreas: ["Maidenhead Town Centre", "Cookham Village"] }
  },
  bracknell: {
    name: "Bracknell",
    county: "Berkshire",
    coordinates: { latitude: "51.4154", longitude: "-0.7516" },
    nearbyAreas: ["Binfield", "Warfield", "Easthampstead", "Crown Wood", "Great Hollands"],
    postalCodes: ["RG12"],
  ...
  oxford: {
    ...
    nearbyAreas: [
      "Headington", "Cowley", "Botley", "Wolvercote", "Summertown", 
      "Marston", "Iffley", "Blackbird Leys", "Rose Hill", "Jericho"
    ],
  ...
  swindon: {
    ...
    nearbyAreas: ["Old Town", "West Swindon", "North Swindon", "Stratton", "Wroughton"],
    postalCodes: ["SN1", "SN2", "SN3", "SN4", "SN5", "SN6"],
    heritage: { conservationAreas: ["Railway Village", "Old Town", "Wood Street"] }
  },
  salisbury: {
    name: "Salisbury",
    county: "Wiltshire",
    coordinates: { latitude: "51.0693", longitude: "-1.7957" },
    nearbyAreas: ["Harnham", "Bemerton Heath", "Laverstock", "Wilton", "Britford"],
    postalCodes: ["SP1", "SP2"],
    heritage: { conservationAreas: ["Salisbury City Centre", "Cathedral Close"] }
  },
  chippenham: {
    name: "Chippenham",
    county: "Wiltshire",
    coordinates: { latitude: "51.4585", longitude: "-2.1158" },
    nearbyAreas: ["Monkton Park", "Pewsham", "Hardenhuish", "Lowden", "Derriads"],
  ...
  gloucester: {
    ...
    nearbyAreas: ["Barnwood", "Longlevens", "Hucclecote", "Tuffley", "Quedgeley"],
  ...
  cheltenham: {
    ...
    nearbyAreas: ["Montpellier", "Pittville", "Charlton Kings", "Leckhampton", "Up Hatherley"],
  ...
  southampton: {
    ...
    heritage: { conservationAreas: ["Old Town", "Oxford Street", "Bevois Valley"] }
  },
  portsmouth: {
    name: "Portsmouth",
    county: "Hampshire",
  ...
  guildford: {
    ...
    nearbyAreas: ["Merrow", "Burpham", "Onslow Village", "Stoughton", "Woodbridge"],
    postalCodes: ["GU1", "GU2", "GU3", "GU4"],
    heritage: { conservationAreas: ["Town Centre", "Charlotteville", "St Catherines"] }
  },
  woking: {
    name: "Woking",
    county: "Surrey",
    coordinates: { latitude: "51.3190", longitude: "-0.5576" },
    nearbyAreas: ["Horsell", "Goldsworth Park", "St Johns", "Knaphill", "Mayford"],
  ...
  crawley: {
    ...
    nearbyAreas: ["Three Bridges", "Pound Hill", "Broadfield", "Tilgate", "Ifield"],
  ...
  worthing: {
    ...
    nearbyAreas: ["Goring", "Durrington", "Broadwater", "Tarring", "Findon Valley"],
