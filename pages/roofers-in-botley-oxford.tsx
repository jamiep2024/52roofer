...
export default function RoofersInBotleyOxford() {
  ...
  return (
<Layout>
<SEO title="Expert Roofers in botley oxford | Emergency Repairs & Installation" description="Looking for trusted roofers in botley oxford? ⭐ 24/7 Emergency Service ⭐ Free Quotes. Local experts serving the area." />
    <>
      <Head>
  ...
  "@graph": [
    {
      ...
      "@id": "https://52roofer.com/roofers-in-botley-oxford#organization",
      "name": "52Roofer",
      "url": "https://52roofer.com/roofers-in-botley-oxford",
    ...
    {
      "@type": "WebPage",
      "@id": "https://52roofer.com/roofers-in-botley-oxford#webpage",
      "url": "https://52roofer.com/roofers-in-botley-oxford",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://52roofer.com/roofers-in-botley-oxford#faq",
      "mainEntity": []
    }
  ]
}`}} />
