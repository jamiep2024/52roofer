...
const ServiceLocationPage = () => {
  const meta = {
    ...
    canonical: 'https://52roofer.com/services/roof replacement/roofers-in-trowbridge',
    schema: {
  ...
  return (
    <ServiceLayout meta={meta}>
      ...
      <p>Our expert team provides comprehensive roof replacement services in Trowbridge, including:</p>
      <ul>
