...
const ServiceLocationPage = () => {
  const meta = {
    ...
    canonical: 'https://52roofer.com/services/roof replacement/roofers-in-marston-oxford',
    schema: {
  ...
  return (
    <ServiceLayout meta={meta}>
      ...
      <p>Our expert team provides comprehensive roof replacement services in Marston Oxford, including:</p>
      <ul>
