...
export default function RoofInstallationPage() {
  const title = "Professional Roof Installation Services | Expert Roofers | 52Roofer";
  const description = "Expert roof installation services from 52Roofer. High-quality materials, professional installation, and competitive pricing. Get a free quote for your new roof today.";
  ...
  const schema = {
    ...
    "description": "Professional roof installation services including new builds and complete replacements",
      ...
      "itemListElement": [
        {
          ...
          "itemOffered": {
            ...
            "description": "Complete new roof installation for residential and commercial properties"
          }
        },
        {
          "@type": "Offer",
          "itemOffered": {
            ...
            "description": "Full roof replacement services with quality materials and expert installation"
          }
        }
      ]
    }
  ...
  return (
    <>
      ...
      >
        ...
        <p>Our professional roof installation service provides comprehensive solutions for both residential and commercial properties. We handle everything from new builds to complete replacements, ensuring your property is protected with a high-quality, durable roof.</p>
        ...
        <p>We use only the highest quality roofing materials from trusted manufacturers. Our selection includes:</p>
        <ul>
        ...
        <p>All materials are chosen for durability, performance, and aesthetic appeal.</p>

        <h2>Expert Installation Team</h2>
        <p>Our installation team consists of fully qualified and experienced roofers who:</p>
        <ul>
        ...
        <p>Contact us today for a free consultation and quote. Our expert team is ready to help you choose the perfect roofing solution for your property.</p>
      </ServiceLayout>
    </>
  );
}
