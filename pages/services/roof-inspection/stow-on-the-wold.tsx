...
const ServiceLocationPage = () => {
  const meta = {
    ...
    canonical: 'https://52roofer.com/services/roof inspection/roofers-in-stow-on-the-wold',
    schema: {
  ...
  return (
    <ServiceLayout meta={meta}>
      ...
      <p>Our expert team provides comprehensive roof inspection services in Stow On The Wold, including:</p>
      <ul>
