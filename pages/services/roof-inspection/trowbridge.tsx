...
const ServiceLocationPage = () => {
  const meta = {
    ...
    canonical: 'https://52roofer.com/services/roof inspection/roofers-in-trowbridge',
    schema: {
  ...
  return (
    <ServiceLayout meta={meta}>
      ...
      <p>Our expert team provides comprehensive roof inspection services in Trowbridge, including:</p>
      <ul>
