...
const ServiceLocationPage = () => {
  const meta = {
    ...
    canonical: 'https://52roofer.com/services/roof repairs/roofers-in-stow-on-the-wold',
    schema: {
  ...
  return (
    <ServiceLayout meta={meta}>
      ...
      <p>Our expert team provides comprehensive roof repairs services in Stow On The Wold, including:</p>
      <ul>
