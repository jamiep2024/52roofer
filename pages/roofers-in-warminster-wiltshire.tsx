...
export default function RoofersInWarminsterWiltshire() {
  ...
  return (
<Layout>
<SEO title="Expert Roofers in warminster wiltshire | Emergency Repairs & Installation" description="Looking for trusted roofers in warminster wiltshire? ⭐ 24/7 Emergency Service ⭐ Free Quotes. Local experts serving the area." />
    <>
      <Head>
  ...
  "@graph": [
    {
      ...
      "@id": "https://52roofer.com/roofers-in-warminster-wiltshire#organization",
      "name": "52Roofer",
      "url": "https://52roofer.com/roofers-in-warminster-wiltshire",
    ...
    {
      "@type": "WebPage",
      "@id": "https://52roofer.com/roofers-in-warminster-wiltshire#webpage",
      "url": "https://52roofer.com/roofers-in-warminster-wiltshire",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://52roofer.com/roofers-in-warminster-wiltshire#faq",
      "mainEntity": []
    }
  ]
}`}} />
  ...
  "@graph": [
    ...
    },
    {
      ...
      <LocalBusinessSchema 
        ...
        location={location}
        url="https://52roofer.com/roofers-in-roofers-in-warminster-wiltshire"
        image="https://52roofer.com/images/hero-bg.jpg"
      />
