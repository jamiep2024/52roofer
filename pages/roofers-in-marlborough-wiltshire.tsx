...
export default function RoofersInMarlboroughWiltshire() {
  ...
  return (
<Layout>
<SEO title="Expert Roofers in marlborough wiltshire | Emergency Repairs & Installation" description="Looking for trusted roofers in marlborough wiltshire? ⭐ 24/7 Emergency Service ⭐ Free Quotes. Local experts serving the area." />
    <>
      <Head>
        ...
        <meta property="og:title" content="Expert Roofers in Marlborough, Wiltshire | Emergency Repairs & Installation" />
        <meta property="og:description" content="Looking for trusted roofers in Marlborough, Wiltshire? 24/7 Emergency Service, Free Quotes. Local experts serving SN8 & surrounding areas." />
        <meta property="og:type" content="website" />
        <meta property="og:url" content="https://52roofer.com/roofers-in-marlborough-wiltshire" />
  ...
  "@graph": [
    {
      ...
      "@id": "https://52roofer.com/roofers-in-marlborough-wiltshire#organization",
      "name": "52Roofer",
      "url": "https://52roofer.com/roofers-in-marlborough-wiltshire",
    ...
    {
      "@type": "WebPage",
      "@id": "https://52roofer.com/roofers-in-marlborough-wiltshire#webpage",
      "url": "https://52roofer.com/roofers-in-marlborough-wiltshire",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://52roofer.com/roofers-in-marlborough-wiltshire#faq",
      "mainEntity": []
    }
  ]
}`}} />
  ...
  "@graph": [
    ...
    },
    {
      ...
      <LocalBusinessSchema 
        ...
        location={location}
        url="https://52roofer.com/roofers-in-roofers-in-marlborough-wiltshire"
        image="https://52roofer.com/images/hero-bg.jpg"
      />
