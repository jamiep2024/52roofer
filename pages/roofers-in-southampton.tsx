...
export default function RoofersInSouthampton() {
  ...
  return (
<Layout>
<SEO title="Expert Roofers in southampton | Emergency Repairs & Installation" description="Looking for trusted roofers in southampton? ⭐ 24/7 Emergency Service ⭐ Free Quotes. Local experts serving the area." />
    <>
      <Head>
  ...
  "@graph": [
    {
      ...
      "@id": "https://52roofer.com/roofers-in-southampton#organization",
      "name": "52Roofer",
    ...
    {
      "@type": "WebPage",
      "@id": "https://52roofer.com/roofers-in-southampton#webpage",
      "url": "https://52roofer.com/roofers-in-southampton",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://52roofer.com/roofers-in-southampton#faq",
      "mainEntity": []
    }
  ]
}`}} />
