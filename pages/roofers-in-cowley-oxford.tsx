...
export default function RoofersInCowleyOxford() {
  ...
  return (
<Layout>
<SEO title="Expert Roofers in cowley oxford | Emergency Repairs & Installation" description="Looking for trusted roofers in cowley oxford? ⭐ 24/7 Emergency Service ⭐ Free Quotes. Local experts serving the area." />
    <>
      <Head>
  ...
  "@graph": [
    {
      ...
      "@id": "https://52roofer.com/roofers-in-cowley-oxford#organization",
      "name": "52Roofer",
      "url": "https://52roofer.com/roofers-in-cowley-oxford",
    ...
    {
      "@type": "WebPage",
      "@id": "https://52roofer.com/roofers-in-cowley-oxford#webpage",
      "url": "https://52roofer.com/roofers-in-cowley-oxford",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://52roofer.com/roofers-in-cowley-oxford#faq",
      "mainEntity": []
    }
  ]
}`}} />
  ...
  "@graph": [
    ...
    },
    {
      ...
      <LocalBusinessSchema 
        businessName="52Roofer Cowley"
        location={location}
        url="https://52roofer.com/roofers-in-roofers-in-cowley-oxford"
        image="https://52roofer.com/images/hero-bg.jpg"
      />
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              <div className="bg-gray-50 p-8 rounded-xl shadow-lg">
                ...
                <LeadForm source="Cowley Landing Page" />
              </div>
