  ...
  return (
    <>
      ...
      <LocationLandingPage
        ...
        description={location.description || `Professional roofing services in ${location.name}, ${location.county}. Our expert team provides comprehensive roofing solutions including repairs, installations, and maintenance.`}
      />
    </>
  );
}
