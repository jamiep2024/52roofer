          ...
          <div className="mb-8">
            <div className="border border-pink-200 rounded-lg p-6 bg-pink-50">
              ...
              <div className="flex flex-wrap gap-3">
                ...
                <a href="mailto:grandeurheritagegroup@gmail.com" className="inline-flex items-center px-4 py-2 bg-amber-700 text-white rounded-lg hover:bg-amber-800 transition-colors">
                  <svg className="w-4 h-4 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
