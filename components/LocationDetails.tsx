  ...
  return (
    <div className="space-y-8">
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-accent/10 hover:shadow-xl transition-shadow">
        <h2 className="text-3xl font-bold mb-6 text-gray-900">About {location.name}</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <p className="text-gray-600 text-lg mb-4 leading-relaxed">{location.history}</p>
          ...
          <div className="space-y-6">
            <div>
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Notable Landmarks</h3>
            ...
            <div>
              <h3 className="text-xl font-semibold mb-3 text-gray-900">Postal Codes</h3>
              <div className="flex flex-wrap gap-2">
                {location.postalCodes.map((code) => (
                  <span key={code} className="bg-accent/5 text-gray-600 px-3 py-1 rounded-full text-sm">
                    {code}
                  </span>
                ))}
              </div>
      ...
      {/* Roofing Information */}
      <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-accent/10 hover:shadow-xl transition-shadow">
        <h2 className="text-3xl font-bold mb-6 text-gray-900">Roofing in {location.name}</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4 text-gray-900">Common Roofing Styles</h3>
          ...
          <div>
            <h3 className="text-xl font-semibold mb-4 text-gray-900">Local Challenges</h3>
            <ul className="space-y-3">
        ...
        <div className="mt-8 p-6 bg-accent/5 rounded-xl">
          <h3 className="text-xl font-semibold mb-3 text-gray-900">Local Regulations</h3>
          <p className="text-gray-600 leading-relaxed">{location.roofingInfo.regulations}</p>
        </div>
      </div>

      {/* Service Areas */}
      <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-accent/10 hover:shadow-xl transition-shadow">
        <h2 className="text-3xl font-bold mb-6 text-gray-900">Areas We Cover</h2>
        <div className="grid md:grid-cols-3 gap-4">
          {location.nearbyAreas.map((area) => (
            <div key={area} className="p-4 bg-accent/5 rounded-xl text-gray-700 hover:bg-accent/10 transition-colors">
              {area}
            </div>
          ))}
        </div>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-accent/10 hover:shadow-xl transition-shadow">
        <h2 className="text-3xl font-bold mb-6 text-gray-900">Local Weather Considerations</h2>
        <div className="grid md:grid-cols-2 gap-8">
          <div>
            <h3 className="text-xl font-semibold mb-4 text-gray-900">Seasonal Maintenance Tips</h3>
            <ul className="space-y-3">
          ...
          <div>
            <h3 className="text-xl font-semibold mb-4 text-gray-900">Weather Patterns</h3>
            <ul className="space-y-3">
              <li className="flex items-center text-gray-600">
                <span className="text-accent mr-2">•</span>
      ...
      <div className="bg-white rounded-2xl shadow-lg p-8 border-2 border-accent/10 hover:shadow-xl transition-shadow">
        ...
        <div className="space-y-6">
          <div className="p-6 bg-accent/5 rounded-xl hover:bg-accent/10 transition-colors">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">How quickly can you respond to emergency roof repairs in {location.name}?</h3>
          ...
          <div className="p-6 bg-accent/5 rounded-xl hover:bg-accent/10 transition-colors">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">What roofing services do you offer in {location.county}?</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="p-6 bg-accent/5 rounded-xl hover:bg-accent/10 transition-colors">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">Do you provide free roofing quotes in {location.name}?</h3>
            <p className="text-gray-600 leading-relaxed">
          ...
          <div className="p-6 bg-accent/5 rounded-xl hover:bg-accent/10 transition-colors">
            <h3 className="text-xl font-semibold mb-3 text-gray-900">What types of roofs do you work with in {location.name}?</h3>
            <p className="text-gray-600 leading-relaxed">
