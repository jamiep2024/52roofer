...
const LeadForm: React.FC<LeadFormProps> = ({ source, className = '' }) => {
  ...
  return (
    <form onSubmit={handleSubmit} className={`bg-gradient-to-br from-primary-500/10 to-accent/5 p-8 rounded-2xl shadow-lg ${className}`}>
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        <div className="relative">
          <label htmlFor="name" className="block text-sm font-semibold text-primary-600 mb-2">
            Name *
          </label>
          <div className="relative">
        ...
        <div className="relative">
          <label htmlFor="phone" className="block text-sm font-semibold text-primary-600 mb-2">
            Phone *
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        <div className="relative">
          <label htmlFor="email" className="block text-sm font-semibold text-primary-600 mb-2">
            Email *
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        <div className="relative">
          <label htmlFor="address" className="block text-sm font-semibold text-primary-600 mb-2">
            Address
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        <div className="relative">
          <label htmlFor="service" className="block text-sm font-semibold text-primary-600 mb-2">
            Service Required *
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
        ...
        <div className="relative">
          <label htmlFor="urgency" className="block text-sm font-semibold text-primary-600 mb-2">
            Urgency *
          </label>
          <div className="relative">
            <div className="absolute inset-y-0 left-0 pl-3 flex items-center pointer-events-none">
      ...
      <div className="mt-6">
        <label htmlFor="message" className="block text-sm font-semibold text-primary-600 mb-2">
          Message
        </label>
        <div className="relative">
