      ...
      <div className="container mx-auto px-4">
        ...
        <div className="flex justify-center items-center gap-4 mt-12">
          <button 
            ...
            className="bg-pink-600 text-white px-10 py-5 rounded-xl font-bold hover:bg-pink-700 transition-all transform hover:scale-110 shadow-lg hover:shadow-xl border-2 border-pink-700"
          >
