      ...
      <div className="container mx-auto px-4">
        <div className="max-w-2xl mx-auto text-center mb-8 md:mb-12">
          ...
          <p className="text-base md:text-lg text-gray-600">
            At Aventus Roofing, we offer all types of roofing services. Our roofing services are affordable & we always provide a detailed inspection & quote before any work begins.
          </p>
        </div>
