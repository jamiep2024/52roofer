...
export default function Hero() {
  return (
    <div className="relative min-h-[600px] bg-cover bg-center" style={{ backgroundImage: 'url(/images/hero-image.jpg)' }}>
      ...
      <div className="container mx-auto px-4 py-8 md:py-16 relative">
        <div className="flex flex-col md:flex-row justify-between items-center gap-8">
          <div className="text-white max-w-2xl order-2 md:order-1">
            ...
            <h1 className="text-4xl md:text-6xl font-bold mb-6 md:mb-8 text-center md:text-left">Your Trusted Local Roofing Experts</h1>
