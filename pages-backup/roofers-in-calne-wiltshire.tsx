...
export default function RoofersInCalneWiltshire() {
  ...
  return (
<Layout>
<SEO title="Expert Roofers in calne wiltshire | Emergency Repairs & Installation" description="Looking for trusted roofers in calne wiltshire? ⭐ 24/7 Emergency Service ⭐ Free Quotes. Local experts serving the area." />
    <>
      <Head>
  ...
  "@graph": [
    {
      ...
      "@id": "https://52roofer.com/roofers-in-calne-wiltshire#organization",
      "name": "52Roofer",
      "url": "https://52roofer.com/roofers-in-calne-wiltshire",
    ...
    {
      "@type": "WebPage",
      "@id": "https://52roofer.com/roofers-in-calne-wiltshire#webpage",
      "url": "https://52roofer.com/roofers-in-calne-wiltshire",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://52roofer.com/roofers-in-calne-wiltshire#faq",
      "mainEntity": []
    }
  ]
}`}} />
      ...
      <LocalBusinessSchema 
        ...
        location={location}
        url="https://52roofer.com/roofers-in-roofers-in-calne-wiltshire"
        image="https://52roofer.com/images/hero-bg.jpg"
      />
