...
export default function RoofersInMelksham() {
  ...
  return (
<Layout>
<SEO title="Expert Roofers in melksham | Emergency Repairs & Installation" description="Looking for trusted roofers in melksham? ⭐ 24/7 Emergency Service ⭐ Free Quotes. Local experts serving the area." />
    <>
      <Head>
  ...
  "@graph": [
    {
      ...
      "@id": "https://52roofer.com/roofers-in-melksham#organization",
      "name": "52Roofer",
    ...
    {
      "@type": "WebPage",
      "@id": "https://52roofer.com/roofers-in-melksham#webpage",
      "url": "https://52roofer.com/roofers-in-melksham",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://52roofer.com/roofers-in-melksham#faq",
      "mainEntity": []
    }
  ]
}`}} />
