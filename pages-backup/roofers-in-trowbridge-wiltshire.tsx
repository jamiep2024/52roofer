...
export default function RoofersInTrowbridgeWiltshire() {
  ...
  return (
<Layout>
<SEO title="Expert Roofers in trowbridge wiltshire | Emergency Repairs & Installation" description="Looking for trusted roofers in trowbridge wiltshire? ⭐ 24/7 Emergency Service ⭐ Free Quotes. Local experts serving the area." />
    <>
      <Head>
  ...
  "@graph": [
    {
      ...
      "@id": "https://52roofer.com/roofers-in-trowbridge-wiltshire#organization",
      "name": "52Roofer",
      "url": "https://52roofer.com/roofers-in-trowbridge-wiltshire",
    ...
    {
      "@type": "WebPage",
      "@id": "https://52roofer.com/roofers-in-trowbridge-wiltshire#webpage",
      "url": "https://52roofer.com/roofers-in-trowbridge-wiltshire",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://52roofer.com/roofers-in-trowbridge-wiltshire#faq",
      "mainEntity": []
    }
  ]
}`}} />
      ...
      <LocalBusinessSchema 
        ...
        location={location}
        url="https://52roofer.com/roofers-in-roofers-in-trowbridge-wiltshire"
        image="https://52roofer.com/images/hero-bg.jpg"
      />
