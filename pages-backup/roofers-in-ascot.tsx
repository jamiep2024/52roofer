...
export default function RoofersInAscot() {
  ...
  return (
<Layout>
<SEO title="Expert Roofers in ascot | Emergency Repairs & Installation" description="Looking for trusted roofers in ascot? ⭐ 24/7 Emergency Service ⭐ Free Quotes. Local experts serving the area." />
    <>
      <Head>
  ...
  "@graph": [
    {
      ...
      "@id": "https://52roofer.com/roofers-in-ascot#organization",
      "name": "52Roofer",
    ...
    {
      "@type": "WebPage",
      "@id": "https://52roofer.com/roofers-in-ascot#webpage",
      "url": "https://52roofer.com/roofers-in-ascot",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://52roofer.com/roofers-in-ascot#faq",
      "mainEntity": []
    }
  ]
}`}} />
