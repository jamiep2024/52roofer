...
export default function RoofersInEastGrinstead() {
  const location = {
    name: 'East Grinstead',
    county: 'West Sussex',
  ...
  return (
<Layout>
<SEO title="Expert Roofers in east grinstead | Emergency Repairs & Installation" description="Looking for trusted roofers in east grinstead? ⭐ 24/7 Emergency Service ⭐ Free Quotes. Local experts serving the area." />
    <>
      <Head>
        ...
        <link rel="canonical" href="https://52roofer.com/roofers-in-east-grinstead" />
        <script type="application/ld+json"> dangerouslySetInnerHTML={{ __html: `{
  "@context": "https://schema.org",
  "@graph": [
    {
      "@type": "RoofingContractor",
      "@id": "https://52roofer.com/roofers-in-east-grinstead#organization",
      "name": "52Roofer",
      "url": "https://52roofer.com/roofers-in-east-grinstead",
    ...
    {
      "@type": "WebPage",
      "@id": "https://52roofer.com/roofers-in-east-grinstead#webpage",
      "url": "https://52roofer.com/roofers-in-east-grinstead",
    ...
    {
      "@type": "FAQPage",
      "@id": "https://52roofer.com/roofers-in-east-grinstead#faq",
      "mainEntity": []
    }
  ]
}`}} />
      ...
      <LocalBusinessSchema 
        businessName="52Roofer East Grinstead"
        location={location}
        url="https://52roofer.com/roofers-in-east-grinstead"
        image="https://52roofer.com/images/hero-bg.jpg"
      />
        ...
        <div className="relative bg-gray-900">
          <div className="absolute inset-0">
            <HeroImage 
              ...
              alt={`Roofing services in East Grinstead`}
            />            
          ...
          <div className="relative max-w-7xl mx-auto py-24 px-4 sm:py-32 sm:px-6 lg:px-8">
            <h1 className="text-4xl font-extrabold tracking-tight text-white sm:text-5xl lg:text-6xl">
              Expert Roofers in East Grinstead
            </h1>
            <p className="mt-6 max-w-3xl text-xl text-gray-300">
              Professional roofing services in East Grinstead, West Sussex. From emergency repairs to complete installations, 
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-16">
            ...
            <div>
              <h2 className="text-3xl font-bold text-gray-900 mb-8">
                Your Trusted Local Roofers in East Grinstead
              </h2>
              ...
              <div className="prose prose-blue max-w-none">
                ...
                <h3 className="text-2xl font-semibold mt-12 mb-4">Why Choose Our East Grinstead Roofers?</h3>
            ...
            <div>
              <div className="bg-gray-50 p-8 rounded-xl shadow-lg">
                ...
                <LeadForm source="East Grinstead Landing Page" />
              </div>

              {/* Coverage Areas */}
              <div className="mt-12">
                <h3 className="text-2xl font-semibold text-gray-900 mb-6">
                  Areas We Cover in East Grinstead
                </h3>
